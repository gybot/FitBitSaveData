...
$ERROR_WINHTTP_12178 = 'Returned by WinHttpGetProxyForUrl when a proxy for the specified URL cannot be located.'
$ERROR_WINHTTP_12180 = 'Returned by WinHttpDetectAutoProxyConfigUrl if WinHTTP was unable to discover the URL of the Proxy Auto-Configuration (PAC) file.'
$ERROR_WINHTTP_12166 = 'An error occurred executing the script code in the Proxy Auto-Configuration (PAC) file.'
$ERROR_WINHTTP_12103 = 'Returned by the HttpRequest object if a specified option cannot be requested after the Open method has been called.'
$ERROR_WINHTTP_12102 = 'Returned by the HttpRequest object if a requested operation cannot be performed after calling the Send method.'
$ERROR_WINHTTP_12100 = 'Returned by the HttpRequest object if a requested operation cannot be performed before calling the Open method.'
$ERROR_WINHTTP_12101 = 'Returned by the HttpRequest object if a requested operation cannot be performed before calling the Send method.'
$ERROR_WINHTTP_12029 = 'Returned if connection to the server failed.'
$ERROR_WINHTTP_12183 = 'Returned by WinHttpReceiveResponse when an overflow condition is encountered in the course of parsing chunked encoding.'
$ERROR_WINHTTP_12044 = 'Returned by WinHttpReceiveResponse when the server requests client authentication.'
$ERROR_WINHTTP_12030 = 'The connection with the server has been reset or terminated, or an incompatible SSL protocol was encountered. For example, WinHTTP version 5.1 does not support SSL2 unless the client specifically enables it.'
$ERROR_WINHTTP_12155 = 'Obsolete; no longer used.'
$ERROR_WINHTTP_12181 = 'Returned by WinHttpReceiveResponse when a larger number of headers were present in a response than WinHTTP could receive.'
$ERROR_WINHTTP_12150 = 'The requested header cannot be located.'
$ERROR_WINHTTP_12182 = 'Returned by WinHttpReceiveResponse when the size of headers received exceeds the limit for the request handle.'
$ERROR_WINHTTP_12019 = 'The requested operation cannot be carried out because the handle supplied is not in the correct state.'
$ERROR_WINHTTP_12018 = 'The type of handle supplied is incorrect for this operation.'
$ERROR_WINHTTP_12004 = 'An internal error has occurred.'
$ERROR_WINHTTP_12009 = 'A request to WinHttpQueryOption or WinHttpSetOption specified an invalid option value.'
$ERROR_WINHTTP_12154 = 'Obsolete; no longer used.'
$ERROR_WINHTTP_12152 = 'The server response cannot be parsed.'
$ERROR_WINHTTP_12005 = 'The URL is not valid.'
$ERROR_WINHTTP_12015 = 'The login attempt failed. When this error is encountered, the request handle should be closed with WinHttpCloseHandle. A new request handle must be created before retrying the function that originally produced this error.'
$ERROR_WINHTTP_12007 = 'The server name cannot be resolved.'
$ERROR_WINHTTP_12172 = 'Obsolete; no longer used.'
$ERROR_WINHTTP_12017 = 'The operation was canceled, usually because the handle on which the request was operating was closed before the operation completed.'
$ERROR_WINHTTP_12011 = 'The requested option cannot be set, only queried.'
$ERROR_WINHTTP_12001 = 'Obsolete; no longer used.'
$ERROR_WINHTTP_12156 = 'The redirection failed because either the scheme changed or all attempts made to redirect failed (default is five attempts).'
$ERROR_WINHTTP_12032 = 'The WinHTTP function failed. The desired function can be retried on the same request handle.'
$ERROR_WINHTTP_12184 = 'Returned when an incoming response exceeds an internal WinHTTP size limit.'
$ERROR_WINHTTP_12177 = 'An error was encountered while executing a script.'
$ERROR_WINHTTP_12038 = 'Returned when a certificate CN name does not match the passed value (equivalent to a CERT_E_CN_NO_MATCH error).'
$ERROR_WINHTTP_12037 = 'Indicates that a required certificate is not within its validity period when verifying against the current system clock or the timestamp in the signed file, or that the validity periods of the certification chain do not nest correctly (equivalent to a CERT_E_EXPIRED or a CERT_E_VALIDITYPERIODNESTING error).'
$ERROR_WINHTTP_12057 = 'Indicates that revocation cannot be checked because the revocation server was offline (equivalent to CRYPT_E_REVOCATION_OFFLINE).'
$ERROR_WINHTTP_12170 = 'Indicates that a certificate has been revoked (equivalent to CRYPT_E_REVOKED).'
$ERROR_WINHTTP_12179 = 'Indicates that a certificate is not valid for the requested usage (equivalent to CERT_E_WRONG_USAGE).'
$ERROR_WINHTTP_12157 = 'Indicates that an error occurred having to do with a secure channel (equivalent to error codes that begin with "SEC_E_" and "SEC_I_" listed in the "winerror.h" header file).'
...
$ERROR_WINHTTP_12045 = 'Indicates that a certificate chain was processed, but terminated in a root certificate that is not trusted by the trust provider (equivalent to CERT_E_UNTRUSTEDROOT).'
$ERROR_WINHTTP_12169 = 'Indicates that a certificate is invalid (equivalent to errors such as CERT_E_ROLE, CERT_E_PATHLENCONST, CERT_E_CRITICAL, CERT_E_PURPOSE, CERT_E_ISSUERCHAINING, CERT_E_MALFORMED and CERT_E_CHAINING).'
$ERROR_WINHTTP_12012 = 'The WinHTTP function support is being shut down or unloaded.'
$ERROR_WINHTTP_12002 = 'The request has timed out.'
$ERROR_WINHTTP_12167 = 'The PAC file cannot be downloaded. For example, the server referenced by the PAC URL may not have been reachable, or the server returned a 404 NOT FOUND response.'
$ERROR_WINHTTP_12176 = 'The script type is not supported.'
$ERROR_WINHTTP_12006 = 'The URL specified a scheme other than "http:" or "https:".'
...
EndFunc   ;==>_WinHttpSimpleBinaryConcat
